...
export const ProductPage: React.FC = () => {
  ...
  const campaignBg = perfume.id === 'aurelis' 
    ? '/src/assets/images/aurelis_campaign_1780222997018.png'
    : perfume.id === 'nocterra'
      ? '/src/assets/images/nocterra_campaign_1780223016557.png'
      : '/src/assets/images/solaire_campaign_1780223040000.png';
